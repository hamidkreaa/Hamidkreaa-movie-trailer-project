...
fury = media.Movie(
    "Fury", " A story of American platon in 2ed world war",
...
hunger_games = media.Movie(
    "Hunger Games", " A really real hunger game show",
...
pretty_women = media.Movie(
    "Pretty Woman", " A Love story btween rich man and poor woman",
...
ghost_busters = media.Movie(
    "Ghost Busters", " An action movie about Ghosts hunting",
    "https://upload.wikimedia.org/wikipedia/en/3/32/Ghostbusters_2016_film_poster.png",  # NOQA
...
# call the method open_movies_page to creates an HTML file which will
# display all in list movies.
